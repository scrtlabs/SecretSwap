...
use secret_toolkit::snip20::{TokenInfo, TokenInfoResponse};
...
impl WasmMockQuerier {
    pub fn handle_query<C: DeserializeOwned>(&self, request: &QueryRequest<C>) -> QuerierResult {
        match &request {
